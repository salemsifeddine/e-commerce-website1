    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('catigory', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='pyp.categoryproduct')),
                ('colors', models.ManyToManyField(to='pyp.Color')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='pyp.order')),
            ],
        ),
        migrations.CreateModel(
            name='SearchItem',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_added', models.DateTimeField(auto_now_add=True)),
                ('order', models.ForeignKey(db_constraint=False, default=0, null=True, on_delete=django.db.models.deletion.CASCADE, to='pyp.order')),
                ('product', models.ForeignKey(db_constraint=False, null=True, on_delete=django.db.models.deletion.CASCADE, to='pyp.product')),
            ],
        ),
        migrations.CreateModel(
            name='Hotdeals',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('categorylist', models.ManyToManyField(to='pyp.CategoryProduct')),
            ],
        ),
    ]
